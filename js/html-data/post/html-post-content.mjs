...
export function changeToHtmlPost(postVariables) {
   const { id, title, body, tag, dateCreated, dateUpdated, media, author, avatar, comments, reactions, count } = postVariables;
  ...
  `;
   ...
   const authorPost = `
      <div class="author-post g-col-12 grid bg-primary shadow mb-6 position-relative" data-id="${id}">
        ${editForm}
